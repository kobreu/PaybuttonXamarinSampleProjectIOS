...
/**
 * Continue a tranaction using a credit workflow after a credit/debit actionRequired callback was called.
 * @since 2.17.0
 */
- (void)continueCreditDebitSelectionWithCredit;

/**
 * Continue a tranaction using a debit workflow after a credit/debit actionRequired callback was called.
 * @since 2.17.0
 */
