...
/**
 * Creates a new application selection response object, used for a ApplicationSelection request.
...
/**
 * Creates a new credit/debit selection response that indicates credit.
 * @return A new response to continue the transaction
 * @since 2.17.0
 */
- (nonnull MPTransactionActionResponse *)responseForCreditDebitSelectionWithCredit;

/**
 * Creates a new credit/debit selection response that indicates debit.
 * @return A new response to continue the transaction
 * @since 2.17.0
 */
- (nonnull MPTransactionActionResponse *)responseForCreditDebitSelectionWithDebit;
